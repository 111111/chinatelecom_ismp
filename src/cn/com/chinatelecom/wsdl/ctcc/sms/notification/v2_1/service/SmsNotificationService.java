...
public class SmsNotificationService extends Service {
    ...
    static {
        URL url = SmsNotificationService.class.getResource("/wsdl/ctcc_sms_notification_service_2_1.wsdl");
        if (url == null) {
            url = SmsNotificationService.class.getClassLoader().getResource("wsdl/ctcc_sms_notification_service_2_1.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(SmsNotificationService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/wsdl/ctcc_sms_notification_service_2_1.wsdl");
        }       
        WSDL_LOCATION = url;
    }
